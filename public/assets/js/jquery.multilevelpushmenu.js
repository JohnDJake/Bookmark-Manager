	...
	$.fn.multilevelpushmenu = function( options ) {
		...
		this.each(function(){
			...
			function updateDOMStructure() {
				var $mainWrapper = ( instance.settings.container.find( 'div#menu' ).length > 0 ) ? instance.settings.container.find( 'div#menu' ) : instance.settings.menu;
			...
			function createBackItem( $levelHolder ) {
				console.log($levelHolder.parent().parent().parent().css("background-color"));
				var $backItem = $( "<div />" )
			...
			function sizeDOMelements() {
				if( !instance.redraw ) {
					...
					instance.settings.container.children( 'div#menu:first' ).css( 'min-height' , '' );
					if( extHeight ) {
						instance.settings.container.height( instance.settings.menuHeight );
						instance.settings.container.css( 'min-height' , instance.settings.menuHeight );
						instance.settings.container.children( 'div#menu:first' ).css( 'min-height' , instance.settings.menuHeight );
					...
					instance.settings.container.children( 'div#menu:first' ).css( 'min-height' , maxHeight + 'px' );
			...
			function sizeElementWidth( $element , size ) {
				...
				$element.children( 'div#menu:first' ).css( 'min-width' , '' );
				$element.children( 'div#menu:first' ).css( 'min-width' , size + 'px' );
				$element.width( size );
			}
